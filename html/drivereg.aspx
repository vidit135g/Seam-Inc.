<%@ Page Language="C#" AutoEventWireup="true" CodeFile="drivereg.aspx.cs" Inherits="html_drivereg" %>
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12" style="margin-top: 8px">
                        ...
                        <div class="field buttons">
                            <asp:Button runat="server" Style="padding: 15px; color: black;" type="submit" class="btn btn-lg green-color" Text="SAVE" ID="submit" OnClick="submit_Click"></asp:Button>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-12" style="margin-top: 8px">
                        ...
                        <div class="field buttons">
                            <a href="#aboutModal" data-toggle="modal" data-target="#mapModal" class="link">
                                <asp:Button runat="server" Style="padding: 15px; color: black;" class="btn btn-lg green-color" Text="View Map" ID="Button1" OnClick="Button1_Click"></asp:Button></a>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <iframe src="location.html" id="map" height="700" width="1300" style="margin-left: 25px; margin-top: -60px; border: 3px solid gray;"></iframe>
