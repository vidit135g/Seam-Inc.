...
<body id="bdy">
    <div id="top">
        <ul class="nav nav-inline top-bar">
            ...
            <li class="nav-item tp"><a href="ride.html" style="text-decoration: none; color: white;">Ride</a></li>
            <li class="nav-item tp"><a href="drive.html" style="text-decoration: none; color: white;">Drive</a></li>
        </ul>
        <ul class="top-bar nav nav-inline" id="second-bar">
            ...
            <li class="nav-item"><a href="signin.html" style="text-decoration: none; color: white;">SIGN IN</a></li>
            <li class="nav-item"><a href="location.html">
                <img src="../img/location.png" style="width: 28px; height: 28px; margin-top: -5px;" alt="ERROR"></a></li>
            <a href="drive.html" style="text-decoration: none; color: white">
                <li id="top-bar-button">BECOME A DRIVER
                </li>
            </a>
            ...
            <div>
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 8px">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <h4 style="font-size: 16px"><span class="label label-default display-6"><a href="signup_new.aspx" style="text-decoration: none; color: black;">SIGN UP</a></span></h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                ...
                <table style="margin-top: 5px">
                    <tr>
                        ...
                        <td style="padding-left: 8px">
                            <h4 style="font-size: 20px"><span class="label label-default display-6"><a href="signup_new.aspx" style="text-decoration: none; color: black;">Sign up to drive</a></span></h4>
                        </td>
                    </tr>
                </table>
            </div>
        </div>
        <form action="signup_new.aspx" method="get" runat="server">
            <div class="form-group name" style="margin-top: 3px; width: 185px;">
                <input type="text" class="form-control fm" name="" id="fna" runat="server" aria-describedby="helpId" placeholder="First Name">
            </div>
            <div class="form-group name" style="width: 185px; margin-left: -5px;">
                <input type="text" class="form-control fm" name="" id="lna" runat="server" aria-describedby="helpId" placeholder="Last Name">
            </div>
            <div class="form-group" style="width: 370px">
                <input type="email" class="form-control fm" name="address" id="address" runat="server" aria-describedby="emailHelpId" placeholder="Email" />
            </div>
            <div class="form-group" style="margin-top: -17px; width: 370px">
                <input type="text" class="form-control fm" name="" id="contact" runat="server" aria-describedby="helpId" placeholder="Phone">
            </div>
            <div class="form-group" style="margin-top: -17px; width: 370px">
                <input type="password" class="form-control fm" name="" id="pass" runat="server" placeholder="Create Password">
            </div>

            <div class="form-group" style="width: 370px">
                <input type="text" class="form-control fm" name="" id="code" runat="server" aria-describedby="helpId" placeholder="Invite Code (Optional)">
            </div>
            <asp:Button type="submit" runat="server" class="btn-submit" Text="SIGN UP TO DRIVE" ID="sub" OnClick="Unnamed1_Click"></asp:Button>
        </form>
        <h4 id="accept1">Or <a href="#">sign up</a> with your rider account.</h4>
        <p id="accept2">
    ...
    <div class="container-fluid" id="last-cont">
        ...
        <h2 style="font-size: 36px; font-weight: lighter">and is currently in its beta phase, do expect some bugs.</h2>
    ...
    <div class="container-fluid" id="box">
        <div>
            <ul id="box-list">
                ...
                <a href="signinrider.aspx" style="text-decoration: none; width: 100%; height: 100%;">
                    <li class="ex exb ">SIGN UP TO RIDE</li>
                </a>
                <a href="signindriver.aspx" style="text-decoration: none;">
                    <li class="ex exb ">BECOME A DRIVER</li>
                </a>
            </ul>
        </div>
    </div>
